...
(
    ...
    [Parameter(Mandatory=$true, HelpMessage="Enter Azure Subscription credentials variable")]
    [string] $credencialAzure,
...
Login-AzureRmAccount -SubscriptionName $subscriptionName -Credential $credencialAzure
